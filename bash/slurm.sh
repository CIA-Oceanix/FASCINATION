...
conda info
source activate run_model #fsc_env #run_model
echo "Environment activated successfully."


HYDRA_FULL_ERROR=1 srun python /Odyssey/private/o23gauvr/code/MLIC/MLIC/playground/train.py #/Odyssey/private/o23gauvr/code/MLIC/MLIC/playground/train.py
