...
declare -a channels_list=([1,2,4,8]) # [1,2,4,8] [1,2,4] [1,2,4,8,8]
declare -a n_conv_per_layer=(1 3) # 2
declare -a kernel_list=(3) #[7,5,3] 
declare -a loss_weights_list=("1,0,1000,0,0,1000,1000,0")
declare -a learning_rate_list=(0.0001 0.001)
declare -a dropout_list=(0)
declare -a pooling=("conv")
#declare -a use_linear_layer=("True" "False")
declare -a use_final_act_func=("True")
...
declare -a save_dir="'$current_branch/test_on_linear_200_epochs_bis'" 
                        ...
                        do
                            ...
                            do
                                ...
                                do
                                    ...
                                    model_config.model_hparams.$model.kernel_list=3 \
